...
serve(async (req) => {
  ...
  try {
    ...
    const params = new URLSearchParams({
      ...
      currency: "BDT",
      tran_id: tranId,
      success_url: successUrl || "https://pranjol-it.lovable.app/payment?status=success",
      fail_url: failUrl || "https://pranjol-it.lovable.app/payment?status=fail",
      cancel_url: cancelUrl || "https://pranjol-it.lovable.app/payment?status=cancel",
      cus_name: name,
